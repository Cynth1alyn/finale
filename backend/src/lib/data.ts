...
export const issues: Issue[] = [
  { issue_id: "I001", topic: "Internet ขัดข้องชั้น 4", detail: "Internet ไม่สามารถใช้งานได้บริเวณชั้น 4 ทั้งชั้น ตั้งแต่ 09:00 น.", solution: "Reset Switch", status: IssueStatus.RESOLVED, report_date: "2026-03-18", reporter_id: "U005" },
];

export const jobs: Job[] = [
  { job_id: "J001", job_title: "ติดตั้งระบบ Network ชั้น 3", description: "วางสาย LAN และตั้งค่า Switch", start_date: "2026-03-01", due_date: "2026-03-15", priority: Priority.HIGH, job_status: JobStatus.DONE, assigned_user_ids: ["U003"] },
];
